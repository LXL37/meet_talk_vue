<template>
  ...
  <div>
    <div class="topBody">
      ...
      <div style="flex: 1;font-size: 20px;margin-right: 70px">关注</div>
    </div>
    ...
    <div class="mainFavorites" >
        <div  @click="pushUserInfo(item.uId)" class="fansInfo" v-for="item in this.followList" >
...
export default {
  ...
  methods:{
    ...
    getFollows(){
      this.$axios.get("/follow/"+this.uId).then(res => {
